		...
		<div id="ms">
			<div id="lf" style="float:left;">
				<div id="menuput" class="dbor">
					...
					<a style="color:#000; font-size:13px; text-decoration:none; cursor:pointer;" href="?do=total">
					<!-- onclick="op('#cover','#cvr','./modal/total.php')"> -->
						<div class="mainmu" >
							進站總人數管理 </div>
					</a>
					<a style="color:#000; font-size:13px; text-decoration:none;cursor:pointer;" href="?do=bottom">
